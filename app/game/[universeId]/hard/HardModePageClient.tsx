...
import { HardModeToolbarWithSection } from "@/components/HardModeToolbarWithSection";

interface HardModePageClientProps {
  universeId: string;
  universeData: UniverseData;
}

export function HardModePageClient({ universeId, universeData }: HardModePageClientProps) {
    ...
    <UniverseDataProvider universeData={universeData}>
      ...
      >
        ...
        <div className="mx-auto px-2 py-4 sm:px-4 sm:py-6 md:px-6">
          ...
          <HardModeToolbarWithSection universeId={universeId} />
        </div>
      </div>
