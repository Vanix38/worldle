...
interface HardModeCharacterImageProps {
  character: Character;
  className?: string;
}

/** Large portrait for hard mode (same asset paths as CharacterAvatar). */
export function HardModeCharacterImage({ character, className = "" }: HardModeCharacterImageProps) {
